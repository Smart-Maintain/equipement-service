...
public class PieceRequestController {
    ...
    @PostMapping
    public ResponseEntity<PieceRequest> createRequest(@RequestBody PieceRequestDto dto) {
    ...
    public ResponseEntity<PieceRequest> updateStatus(@PathVariable UUID id, @RequestBody PieceRequestStatusDto dto) {
