...
public class RapportController {
    ...
    @PostMapping
    public Rapport create(@RequestBody RapportRequest request) {
        return rapportService.create(request);
    }

    @PutMapping("/{id}")
    public Rapport update(@PathVariable UUID id, @RequestBody RapportRequest request) {
    ...
    public Rapport review(@PathVariable UUID id, @RequestBody RapportReviewRequest request) {
